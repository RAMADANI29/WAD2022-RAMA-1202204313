...
<html>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarNav" style="margin-left: 100px;">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item mx-4">
                            <a class="nav-link" href="<?php echo $jumlah_mobil == 0 ? "pages/Add-RAMADANI.php" : "pages/ListCar-RAMADANI.php"?>" style="text-decoration: none;" class="link-light <?php echo basename($_SERVER['PHP_SELF']) == 'ListCar-RAMADANI.php' ? "" : "text-secondary"; ?>">MyCar</a>
                        </li>
                    </ul>
        ...
        <?php require './pages/Home-RAMADANI.php'?>
    </body>
</html>